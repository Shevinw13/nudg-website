...
const KEY_FEATURES = [
  ...
  },
  {
    ...
    screenAlt: "Nudgli inbox showing customer feedback that needs attention with call, text, and resolve actions",
  },
  {
    icon: "chart",
    ...
    screenAlt: "Nudgli dashboard showing monthly trends with comparison to previous period",
  },
  {
    icon: "bell",
