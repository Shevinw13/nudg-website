    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-8 py-16">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-700 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-navy [&_h2]:mt-8 [&_h3]:text-lg [&_h3]:font-medium [&_h3]:text-navy [&_h3]:mt-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2">
        ...
        <ul>
          ...
          <li><strong>Google Business Profile:</strong> For directing customers to leave reviews and for pulling publicly available review data via the Google Places API. Subject to Google&apos;s Terms of Service.</li>
        ...
        <ul>
          ...
          <li>AI-generated analysis and response suggestions are provided as guidance only. You are solely responsible for any actions you take, including reporting reviews to Google or posting public responses.</li>
          <li>You will only report reviews to Google that you genuinely believe violate Google&apos;s review policies. Abuse of reporting mechanisms may violate Google&apos;s Terms of Service.</li>
          <li>Response suggestions generated by AI are drafts. You are responsible for reviewing and editing any response before posting it publicly.</li>
          <li>Review data is stored for 30 days and then automatically deleted.</li>
          <li>Nudgli does not access your Google account. It only reads publicly available review data via the Google Places API using your Google Review URL.</li>
          <li>Review Shield is not available on the Starter plan. Starter users can see the feature but must upgrade to access it.</li>
        </ul>
        <p>
